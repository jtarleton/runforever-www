...
class nielsen_pcc_data extends Baseobject 
{
public $pcc_ext;
	public $pcc;
		/**
...
class nielsen_pcc_dataTable extends Baseobject{
    public static function get($id, $data=null) {
		return new nielsen_pcc_data($id, $data);
    }
...
$pdo = parent::Connect();
	...
	$stmt=$pdo->prepare("SELECT * FROM nielsen_pcc_data  LIMIT $offset,$limit;");
		
	
	//$stmt->bindValue(':pcc_ext', 'pcc_ext', PDO::PARAM_STR);
		
	
	//$stmt->bindValue(':pcc', 'pcc', PDO::PARAM_STR);
		$stmt->execute();
	$objs = array();
...
$pdo = parent::Connect();
	...
	$stmt=$pdo->prepare('INSERT INTO nielsen_pcc_data ( pcc_ext,pcc) VALUES(:pcc_ext,:pcc');
...
$pdo = parent::Connect();
	...
	$stmt=$pdo->prepare('UPDATE nielsen_pcc_data SET pcc_ext=:pcc_ext,pcc=:pcc');
	...
	$stmt->bindValue(':pcc', $changes['pcc'], PDO::PARAM_STR);
		$stmt->execute();
...
$offset=$offset*$limit;
$objs = nielsen_pcc_dataTable::getAll($offset,$limit);
...
$ct=nielsen_pcc_dataTable::getCount();
$mod = $ct%$limit;
