...
$pdo = parent::Connect();
	...
	$stmt=$pdo->prepare('INSERT INTO nyrr_race_results ( rid,race_name,date,finisher_name,gender_age,city,team,distance,net,pace,overall,gender,age,agegraded,age_graded_percentage,photo) VALUES(:rid,:race_name,:date,:finisher_name,:gender_age,:city,:team,:distance,:net,:pace,:overall,:gender,:age,:agegraded,:age_graded_percentage,:photo');
