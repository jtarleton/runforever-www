...
class AdidAdvEntityDetails extends Baseobject 
{
...
class AdidAdvEntityDetailsTable extends Baseobject{
    public static function get($id, $data=null) {
		return new AdidAdvEntityDetails($id, $data);
    }
...
$pdo = parent::Connect();
	...
	$stmt=$pdo->prepare("SELECT * FROM AdidAdvEntityDetails  LIMIT $offset,$limit;");
...
$offset=$offset*$limit;
$objs = AdidAdvEntityDetailsTable::getAll($offset,$limit);
...
$ct=AdidAdvEntityDetailsTable::getCount();
$mod = $ct%$limit;
