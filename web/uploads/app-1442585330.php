...
foreach($data as $prop=>$value) {
    ...
    }    public function get"nielsenAdvertiserCode"() {
        return $this->"nielsen_advertiser_code";
    }    public function get"nielsenAdvertiserEntity"() {
        return $this->"nielsen_advertiser_entity";
    }    public function get"parentType"() {
        return $this->"parent_type";
    }    private function set"cId"($"cid") {
        $this->"cid" = $"cid";
    }    private function set"parentId"($"parent_id") {
        $this->"parent_id" = $"parent_id";
    }    private function set"parent"($"parent") {
        $this->"parent" = $"parent";
    }    private function set"advertiserId"($"advertiser_id") {
        $this->"advertiser_id" = $"advertiser_id";
    }    private function set"advertiser"($"advertiser") {
        $this->"advertiser" = $"advertiser";
    }    private function set"nielsenAdvertiserCode"($"nielsen_advertiser_code") {
        $this->"nielsen_advertiser_code" = $"nielsen_advertiser_code";
    }    private function set"nielsenAdvertiserEntity"($"nielsen_advertiser_entity") {
        $this->"nielsen_advertiser_entity" = $"nielsen_advertiser_entity";
    }    private function set"parentType"($"parent_type") {
