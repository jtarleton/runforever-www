...
class Baseobject extends Database {
	public function __construct() {
		$dsn = sprintf('mysql://%s:%s@%s/%s','root', 'pass', 'localhost', 'test_dw');
...
$pdo = parent::Connect();
	...
	$stmt=$pdo->prepare('INSERT INTO cea_requests ( id,response_status,response,request_type,request_id,userid,ip_address,request_date) VALUES(:id,:response_status,:response,:request_type,:request_id,:userid,:ip_address,:request_date');
...
$pdo = parent::Connect();
	...
	$stmt=$pdo->prepare('UPDATE cea_requests SET id=:id,response_status=:response_status,response=:response,request_type=:request_type,request_id=:request_id,userid=:userid,ip_address=:ip_address,request_date=:request_date');
