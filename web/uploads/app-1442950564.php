...
class churn_archived_account_churn_status extends Baseobject 
{
public $bid;
	public $name;
...
class churn_archived_account_churn_statusTable extends Baseobject{
    public static function get($id, $data=null) {
		return new churn_archived_account_churn_status($id, $data);
    }
  ...
  public static function getCount(){
   	...
   	$stmt=$pdo->prepare("SELECT count(*) as ct
		FROM churn_archived_account_churn_status");
	$stmt->execute();
...
$pdo = parent::Connect();
	...
	$stmt=$pdo->prepare("SELECT * FROM churn_archived_account_churn_status  LIMIT $offset,$limit;");
...
$pdo = parent::Connect();
	...
	$stmt=$pdo->prepare('INSERT INTO churn_archived_account_churn_status ( bid,name,ytd_churn_status,jan_churn_status,feb_churn_status,march_churn_status,april_churn_status,may_churn_status,june_churn_status,july_churn_status,august_churn_status,sept_churn_status,oct_churn_status,nov_churn_status,dec_churn_status,year) VALUES(:bid,:name,:ytd_churn_status,:jan_churn_status,:feb_churn_status,:march_churn_status,:april_churn_status,:may_churn_status,:june_churn_status,:july_churn_status,:august_churn_status,:sept_churn_status,:oct_churn_status,:nov_churn_status,:dec_churn_status,:year');
...
$pdo = parent::Connect();
	...
	$stmt=$pdo->prepare('UPDATE churn_archived_account_churn_status SET bid=:bid,name=:name,ytd_churn_status=:ytd_churn_status,jan_churn_status=:jan_churn_status,feb_churn_status=:feb_churn_status,march_churn_status=:march_churn_status,april_churn_status=:april_churn_status,may_churn_status=:may_churn_status,june_churn_status=:june_churn_status,july_churn_status=:july_churn_status,august_churn_status=:august_churn_status,sept_churn_status=:sept_churn_status,oct_churn_status=:oct_churn_status,nov_churn_status=:nov_churn_status,dec_churn_status=:dec_churn_status,year=:year');
...
$offset=$offset*$limit;
$objs = churn_archived_account_churn_statusTable::getAll($offset,$limit);
...
$ct=churn_archived_account_churn_statusTable::getCount();
$mod = $ct%$limit;
