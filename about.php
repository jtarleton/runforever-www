  ...
  <div class="sticky">
   <?php require('top.html'); ?>
    ...
    <div class="container clearfix mt-100 mb-20">
      <h2><span>About Run Forever</span></h2>
      <div class="c12 row">
        <p>Run Forever aims to be an informational resource for recreational and amateur road runners of all levels.</p>
      </div>  
      <div class="row">    
        <div class="c4 about ta-c">
